...
PAGES = {
    "home":     ("HomePageHtml",     "VARAGH",                     "home",     ""),
    "files":    ("FilesPageHtml",    "Files - VARAGH",             "files",    '  <script src="/js/jszip.min.js"></script>'),
    "settings": ("SettingsPageHtml", "Settings - VARAGH",          "settings", ""),
    "fonts":    ("FontsPageHtml",    "Fonts - VARAGH",             "fonts",    ""),
}
